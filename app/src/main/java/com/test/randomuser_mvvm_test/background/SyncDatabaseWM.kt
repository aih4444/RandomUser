package com.test.randomuser_mvvm_test.background
...
class SyncDatabaseWM (appContext: Context, params:WorkerParameters): CoroutineWorker(appContext, params),
    ...
    val dataSyncRepository: UserRepository by inject()

    companion object{
        const val WORK_NAME="com.test.randomuser_mvvm_test.background.SyncDatabaseWM"
    }
    override suspend fun doWork(): Result {
         ...
         */
        try{
            dataSyncRepository.refreshUser()
